<?php
	...
	function ident_detect_file_db( $file, $title, $movies = TRUE, $imdb = FALSE, $season = FALSE, $episode = FALSE ){
        ...
        && count( $mediainfo ) > 0
            ...
            if( $debug ) echo "<br />---MEDIAINFO FINDED (SIMSEARCHTITLE): " . count( $mediainfo );
            $similars = array();
            $midata = array();
            ...
            && count( $mediadata ) > 0
                ...
                if( $debug ) echo "<br />---MEDIA FINDED (FILETITLE): " . count( $mediadata );
                $similars = array();
                $midata = array();
                ...
                //if( $pcmin > $MINSIMILARITY ) $pcmin = $MINSIMILARITY;
                $pcmin = $MINSIMILARITY;
